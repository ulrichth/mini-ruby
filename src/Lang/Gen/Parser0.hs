...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	(_,L.EOF) -> cont 7;
	(_, L.TokenM877102771 _) -> cont 8;
	(_, L.TokenM1906462069 _) -> cont 9;
	(_, L.Token1785060526 _) -> cont 10;
	(_, L.Token1359145929 _) -> cont 11;
	(_, L.TokenM1480547472 _) -> cont 12;
	(_, L.Token152256527 _) -> cont 13;
	(_, L.TokenM585301981 _ _) -> cont 14;
	(_, L.Token1967005722 _) -> cont 15;
	_ -> happyError' (tk:tks)
	}
